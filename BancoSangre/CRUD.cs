...
namespace BancoSangre
{
    internal class CRUD
    {
        ...
        // Método actualizar
        public void actualizar(string textoNom, string textoApe, string textoDNI, string textoDirec, string textoTelf, string textoNac, string textoEma, string textoGru, string textoRh)
        {
            try
            {
                SqlConnection con = new SqlConnection(conexion);
